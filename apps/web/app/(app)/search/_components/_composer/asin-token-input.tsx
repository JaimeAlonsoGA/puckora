...
const ASIN_GLOBAL = /\b(B[0-9A-Z]{9})\b/g

/** Build safe HTML: escape entities first, then wrap ASIN patterns in atomic spans. */
...
export function AsinTokenInput({
    ...
    useEffect(() => {
        ...
        if (domText !== value) {
            div.innerHTML = value ? buildHtml(value) : ''
    ...
    function handleKeyDown(e: React.KeyboardEvent) {
        if (e.key === 'Enter' && !e.shiftKey && !disabled) { e.preventDefault(); onSubmit() }
    }
